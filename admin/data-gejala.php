        ...
        <div class="row">
            <div class="col-12">
                ...
                <div class="card card-outline card-primary">
                        ...
                        <?php
                            $query = mysqli_query($koneksi, "
                                ...
                                FROM 
                                    gejala_user
                                INNER JOIN 
                                    hama_penyakit ON gejala_user.id_hama_penyakit = hama_penyakit.id
                                ORDER BY 
                        ...
                        <table id="basicTable" class="table table-bordered table-striped">
                            ...
                            <tbody>
                                ...
                                <div class="modal-dialog">
                                    <form action="proses/edit-data-gejala.php" method="POST">
                                    <input type="hidden" name="id" value="<?= $row['id'] ?>">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                        <h5 class="modal-title" id="modalEditLabel<?= $row['id'] ?>">Edit Data Gejala</h5>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="kode_gejala" class="form-control" value="<?= htmlspecialchars($row['kode_gejala']) ?>" required>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="gejala" class="form-control" value="<?= htmlspecialchars($row['gejala']) ?>" required>
                                        </div>
                                ...
                                <div class="modal fade" id="modalHapus<?= $row['id'] ?>" tabindex="-1">
                                    <div class="modal-dialog">
                                        <form action="proses/hapus-data-gejala.php" method="POST">
                                            <input type="hidden" name="id" value="<?= $row['id'] ?>">
                                            <div class="modal-content">
                                                <div class="modal-header">
                    ...
                    <div class="modal-dialog">
                        <form action="proses/tambah-data-gejala.php" method="POST">
                        <div class="modal-content">
                            <div class="modal-header">
                            <h5 class="modal-title" id="modalTambahBasicLabel">Tambah Data Gejala</h5>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                <span>&times;</span>
                            </button>
                            </div>
                            ...
                            <div class="form-group">
                                <label for="kode_gejala">Kode Gejala</label>
                                <input type="text" name="kode_gejala" class="form-control" placeholder="Masukkan kode gejala..." required>
                            </div>
